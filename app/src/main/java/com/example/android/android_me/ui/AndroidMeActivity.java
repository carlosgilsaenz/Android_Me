...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    // compete (2) Create a new class called MasterListFragment which will display the GridView list of ALL AndroidMe images
    ...
    // completes (4) Create a new Activity named MainActivity and a corresponding layout file that displays a MasterListFragment
